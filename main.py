...
title_label = canvas.create_text(400, 150, text="", font=("Ariel", 40, "italic"), fill=BLACK)
word_label = canvas.create_text(400, 263, text="", font=("Arial", 60, "bold"), fill=BLACK, anchor='center')
canvas.config(bg=BACKGROUND_COLOR, highlightthickness=0)
canvas.grid(row=0, column=0, columnspan=2)

cross_image = PhotoImage(file="images/wrong.png")
unknown_button = Button(image=cross_image, highlightbackground=BACKGROUND_COLOR, command=gen_word)
